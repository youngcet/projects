...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <a href="#footer" class="w3-bar-item w3-button w3-padding">My Invoices</a><br/><br/> 
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-container w3-padding-32">
    ...
    <p><input class="w3-input w3-border" type="text" placeholder="Enter message" style="width:100%"></p>
    <input type="submit" class="w3-button w3-red w3-margin-bottom" value="SEND MESSAGE">
  </div>
  </form>
